...
$ python 3D_soccer.py --env 3DBall --stop-reward [..]
  [--framework=torch]?
"""
...
parser.add_argument(
    "--env",
    type=str,
    default="SoccerStrikersVsGoalie",
    choices=[
        "3DBall",
        "3DBallHard",
        "GridFoodCollector",
...
if __name__ == "__main__":
    ...
    # 1. Load
    checkpoint_path = (
        "/Users/wehrenberger/ray_results/PPO_2023-12-01_18-00-08/PPO_unity3d_15170_00000_0_2023-12-01_18-00"
    ...
    for i in range(2):
        trainer.train()
        print(f"#{i} training step")

    # 3. Save as pt, Striker, Goalie
    # trainer.get_policy("Goalie").export_model("./models_soccer", onnx=9)
